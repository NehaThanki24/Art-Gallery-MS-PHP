                    ...
                    while ($row = mysqli_fetch_array($ret)) {
                      ...
                      <form class="form-validate form-horizontal" method="post" action="">
                        <div class="form-group ">
                          <label for="fullname" class="control-label col-lg-2">Page Title <span
                        ...
                        <div class="form-group ">
                          <label for="address" class="control-label col-lg-2">Page Description <span
                              class="required">*</span></label>
                          <div class="col-lg-10">
                            <textarea class=" form-control" id="pagedes" name="pagedes" type="text" required="true"
